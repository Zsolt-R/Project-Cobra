...
function add_child_scripts() {
  ...
  wp_enqueue_script( 'theme_fancybox', get_stylesheet_directory_uri().'/assets/js/min/jquery.fancybox.pack.js', array('jquery'), '1.0.1', true );
...
require get_stylesheet_directory() . '/theme-modules/wps-menu-three/wps-module-menu-three-init.php';

  // Custom Typography ( Uncomment to use ).
  require get_stylesheet_directory() . '/inc/settings/child-admin-tinymce.php';
